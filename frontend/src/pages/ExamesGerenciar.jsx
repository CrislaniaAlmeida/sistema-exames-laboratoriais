...
function ExamesGerenciar() {
  ...
  function montarPayload() {
    // Converte campos de ID vazios para null, e strings vazias tambem para null
    // (evita mandar "" quando o campo e opcional)
    const payload = { ...form };
    ...
    <div className="gerenciar">
      <header className="gerenciar-header">
        ...
        <div className="gerenciar-user">
          <Link to="/exames" className="gerenciar-voltar">← Voltar para a busca</Link>
